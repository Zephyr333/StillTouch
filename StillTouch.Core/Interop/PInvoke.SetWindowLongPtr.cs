...
internal static partial class PInvoke // SetWindowLong build for AnyCPU, win-x86
{
    ...
    // Keep the previous window procedure as a native function pointer. Converting it back to a
    // managed WNDPROC can return WinForms' original internal delegate and throw InvalidCastException.
    [LibraryImport("user32.dll", EntryPoint = "CallWindowProcW")]
    internal static partial nint CallWindowProcRaw(
